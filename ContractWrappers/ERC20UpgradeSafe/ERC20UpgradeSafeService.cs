...
using ContractWrappers.Contracts.ERC20UpgradeSafe.ContractDefinition;

namespace ContractWrappers.Contracts.ERC20UpgradeSafe
{
    public partial class ERC20UpgradeSafeService
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.Web3 web3, ERC20UpgradeSafeDeployment eRC20UpgradeSafeDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<ERC20UpgradeSafeDeployment>().SendRequestAndWaitForReceiptAsync(eRC20UpgradeSafeDeployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.Web3 web3, ERC20UpgradeSafeDeployment eRC20UpgradeSafeDeployment)
        {
            return web3.Eth.GetContractDeploymentHandler<ERC20UpgradeSafeDeployment>().SendRequestAsync(eRC20UpgradeSafeDeployment);
        }

        public static async Task<ERC20UpgradeSafeService> DeployContractAndGetServiceAsync(Nethereum.Web3.Web3 web3, ERC20UpgradeSafeDeployment eRC20UpgradeSafeDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, eRC20UpgradeSafeDeployment, cancellationTokenSource);
            return new ERC20UpgradeSafeService(web3, receipt.ContractAddress);
        }
        ...
        public ERC20UpgradeSafeService(Nethereum.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
